    ...
    <section id="testimoni" className="bg-slate-950 py-20 px-4">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-200 mt-4 max-w-xl mx-auto">Ratusan pelanggan telah mempercayakan pembelian mobil mereka kepada kami.</p>
        </div>
        ...
        <div className="text-center mt-12">
          <p className="text-gray-200 mb-4">Ingin menjadi pelanggan puas kami berikutnya?</p>
