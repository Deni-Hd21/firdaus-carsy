...
export default function WhatsAppFloat() {
  ...
  return (
      ...
      <a href="https://wa.me/6281294412914?text=Halo Pak Aldi, saya ingin konsultasi mengenai kredit mobil syariah"
      target="_blank"
      onClick={handleClick}
    ...
    >
      ...
      <div className={`
        ...
        shadow-lg hover:shadow-green-500/40 hover:shadow-xl
